...
const dates = [
  moment('2021-01-01T00:00:00.000+00:00'),
  moment('2021-01-02T00:00:00.000+00:00'),
  moment('2021-01-03T00:00:00.000+00:00'),
  moment('2021-01-04T00:00:00.000+00:00'),
  moment('2021-01-05T00:00:00.000+00:00'),
  moment('2021-01-06T00:00:00.000+00:00'),
  moment('2021-01-07T00:00:00.000+00:00'),
]
...
describe('Cache', () => {
  it('returns false for an empty cache', () => {
    ...
    const args: Partial<IterArgs> = {
      after: moment('2021-01-01T00:00:00.000+00:00'),
      before: moment('2021-01-08T00:00:00.000+00:00'),
      inc: true,
    }
  ...
  it('does not return cached entries if the "what" matches but the args do not', () => {
    ...
    expect(
      cache._cacheGet('between', {
        ...
        after: moment('2021-01-01T00:00:00.001+00:00'),
      })
    ).toBe(false)
  })
  ...
  it('reuses dates cached for the "all" method when querying using another method', () => {
    const cache = new Cache()
    const args: Partial<IterArgs> = {
      after: moment('2021-01-04T00:00:00.000+00:00'),
      before: moment('2021-01-06T00:00:00.000+00:00'),
      inc: true,
    }
